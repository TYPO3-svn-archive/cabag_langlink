...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/cabag_langlink/'.TYPO3_version.'/class.user_tslib_content_typolinkHook.php']) {
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/cabag_langlink/'.TYPO3_version.'/class.user_tslib_content_typolinkHook.php']);
}
